...
一款纯静态、单文件的科技风机构展示页，内置 **55 种经典机械机构** 的实时运动学仿真动画。所有机构都由 JavaScript 按真实几何关系逐帧求解（而非预设逐帧动画），辅助机械设计选型与方案构思。支持**全文搜索**与 **极夜 / 曜白 / 熔金** 三主题切换。
...
- **55 种机构 · 9 大分类** —— 连杆、凸轮、齿轮、间歇、螺旋、夹紧、液压、万向、挠性传动，支持分类筛选
...
| 分类 | 机构 |
| --- | --- |
| 连杆机构 | 曲柄滑块 · 曲柄摇杆四连杆 · 转动导杆急回 · 平行四连杆 · 剪叉升降 · 双曲柄 · 双摇杆 · 正弦机构（十字滑块）· 椭圆规 · 反平行四边形 · 瓦特直线导向 · 曲柄摇块 · 曲柄压力机 · V型发动机 · 雨刮机构 |
| 凸轮机构 | 盘形凸轮（直动从动件）· 凸轮摆动从动杆 · 移动凸轮 · 槽凸轮 · 圆柱凸轮 · 凸轮平底从动件 |
| 齿轮机构 | 齿轮传动 · 行星齿轮 · 蜗轮蜗杆 · 齿轮泵 · 齿轮齿条 · 锥齿轮 · 扇形齿轮 · 差速器 · 内啮合齿轮 · 谐波减速器 |
| 间歇机构 | 棘轮 · 槽轮（Geneva）· 不完全齿轮 · 超越离合器 · 擒纵机构 · 凸轮分度机构 |
| 螺旋机构 | 螺旋传动（丝杠螺母）· 滚珠丝杠 · 螺旋千斤顶 · 差动螺旋 · 螺旋输送 |
| 夹紧机构 | 机械手夹持器 · 偏心夹紧 · 铰链夹紧 · 楔块夹紧 · 螺旋夹紧 · 联动夹紧 |
| 液压机构 | 液压缸 · 液压千斤顶 · 液压马达 |
| 万向传动 | 万向联轴节 |
| 挠性传动 | 带传动 · 链传动 · 摩擦轮 |
